...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_delete_zeros_oxXu.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: hhow-cho <hhow-cho@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/23 18:12:41 by hhow-cho          #+#    #+#             */
/*   Updated: 2019/04/23 19:47:21 by hhow-cho         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char *ft_delete_zeros_oxXu(char *str, t_flag *flag, int sign)
{
    ...
    // plus de 0 à delete
    if (ft_count_zeros_possible_to_delete_oxXu(str, flag, sign) == 0)
        return (str);
    ...
    return (ft_delete_zeros_oxXu(str, flag, sign));
}
