...
// printf("\n\n\n");
//     ft_printf(" ft_printf :|%.1150f|%.1150f|%.1150f|%.1150f\n", 0x1p-1074, 0x1.ffffffffffffep-1023, 0x1.4e46p-1058, 0x1.59a8b0c3dp-1037);
// 	printf("    printf :|%.1150f|%.1150f|%.1150f|%.1150f", 0x1p-1074, 0x1.ffffffffffffep-1023, 0x1.4e46p-1058, 0x1.59a8b0c3dp-1037);
//     printf("\n\n\n");

    // ft_printf(" ft_printf :|%.f|%-.f|%+.f|% .f|%#.f|%0.f", 0., 0., 0., 0., 0., 0.);
	// printf("    printf :|%.f|%-.f|%+.f|% .f|%#.f|%0.f", 0., 0., 0., 0., 0., 0.);
    // printf("\n\n\n");

    // ft_printf(" ft_printf %.f|%.f|%.f|%.f|%.f\n", 0.499, 44.4, 44.6, 44.50001, 44.5 + 1e-5);
	// printf("    printf %.f|%.f|%.f|%.f|%.f", 0.499, 44.4, 44.6, 44.50001, 44.5 + 1e-5);
    // printf("\n\n\n");

	// printf("    printf 0.5 :|%.f", 0.5);
    // printf("\n\n\n");
	// printf("    printf 1.5 :|%.f", 1.5);
    // printf("\n\n\n");
    // printf("    printf 2.5 :|%.f", 2.5);
    // printf("\n\n\n");
    // printf("    printf 3.5 :|%.f", 3.5);
    // printf("\n\n\n");
    // printf("    printf 4.5 :|%.f", 4.5);
    // printf("\n\n\n");
